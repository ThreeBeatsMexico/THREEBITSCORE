...
namespace ThreeBits.Api.Security.Controllers
{
	...
	public class SecurityController : ControllerBase
	{
		...
		[Authorize]
		public ActionResult updMenuxAppRol(long idMenu, string Menu, string Img, string TpoObj, string Url, string Tool, long Orden, bool Activo)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Authorize]
		public ActionResult updSubMenuxAppRol(long idPermisoMenu, long IdPermisoSubmenu, string SubMenu, string Img, string TpoObj, string Url, string Tool, long Orden, bool Activo)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Authorize]
		public ActionResult addMenuxAppRol(long Rol, string Menu, string Img, string Obj, string Url, string Tool, long Orden)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Authorize]
		public ActionResult addSubMenuxAppRol(long IdSubMenu, string SubMenu, string Img, string Obj, string Url, string Tool, long Orden)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Authorize]
		public ActionResult addPermisosxObjeto(long IdRol, string Pagina, string Obj, string TipoObj, string Tool)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Authorize]
		public ActionResult addPermisosxElementoObjeto(long IdPermiosObj, string Elemento, string Tool)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Route("delMenu")]
		[Authorize]
		public ActionResult delMenu(long IdMenu)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
		...
		[Route("delSubMenu")]
		[Authorize]
		public ActionResult delSubMenu(long idSubMenu)
		{
			ProcessResult oRes = new ProcessResult();
			AplicacionBE oApp = new AplicacionBE();
			string xAppId = _httpContextAccessor.HttpContext.Request.Headers["XAPPID"];
