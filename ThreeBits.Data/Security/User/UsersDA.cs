...
{
    public class UsersDA : SqlDataContext, IUsersDA 
    {
        ...
        public UsuariosBE addUsuario(ReglasBE Reglas, UsuariosBE Usuario, List<DomicilioBE> Domicilios, List<ContactoBE> Contactos, List<RolesXUsuarioBE> RolesXUsuario, Int64 App)
            ...
            try
                {
                 var dbCommand = new SqlCommand("sp_insUser")
                {
                    CommandType = CommandType.StoredProcedure
                };
                dbCommand.Parameters.Add("@IDAPLICACION", SqlDbType.Int).Value = Usuario.IDAPLICACION;
                ...
                dbCommand.Parameters.Add("@IDUSUARIOAPP", SqlDbType.Int).Value = Usuario.IDUSUARIOAPP;
                ...
                dbCommand.Parameters.Add("@FECHANACCONST", SqlDbType.VarChar).Value = Usuario.FECHANACCONST;
                ...
                dbCommand.Parameters.Add("@FECHAALTA", SqlDbType.VarChar).Value = DateTime.Now;
                dbCommand.Parameters.Add("@ACTIVO", SqlDbType.Bit).Value = Usuario.ACTIVO;
                dbCommand.Parameters.Add("@IDUSERMODIFICA", SqlDbType.Int).Value = Reglas.IDUSRMODIF;
                dbCommand.Parameters.Add("@IDAPPMODIFICA", SqlDbType.Int).Value = App;
                if (ExecuteReader(ref dbCommand, out DataTable DataTable, out string dbError))
                {
                    foreach (DataRow row in DataTable.Rows)
                    {
                        IdUsuario = Int64.Parse(row["Numero"].ToString());
            ...
            //        var Cliente = dboSecurity.Usuarios.FromSqlRaw("exec sp_getUsuario @TIPOBUSQUEDA, @USUARIO, @IDAPLICACION", Reglas.TIPOBUSQUEDA, Reglas.USUARIO, Reglas.IDAPP).ToList();
            ...
            //            UsuarioRES.IDAPLICACION = long.Parse(s.Idusuarioapp.ToString());
            ...
            //            UsuarioRES.DESCTIPOUSUARIO = "";
            //            UsuarioRES.IDUSUARIOAPP = s.Idusuarioapp;
            //            UsuarioRES.APATERNO = s.Amaterno;
            //            UsuarioRES.AMATERNO = s.Apaterno;
            //            UsuarioRES.NOMBRE = s.Nombre;
            //            UsuarioRES.FECHANACCONST = s.Fechanacconst;
            //            UsuarioRES.USUARIO = s.Usuario1;
